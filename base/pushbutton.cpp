...
PushButton::PushButton(QWidget *parent)
	: QPushButton(parent)
{
	this->setStyleSheet("QPushButton{background:#F5F5F5; font:14px SIMHEI; border-color:#D2D2D2; border-radius:2px;border-width:1px; border-style:solid; padding: 5px 10px 5px 10px;} \
